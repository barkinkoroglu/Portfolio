...
function Banner() {
  ...
  return (
    ...
    >
      ...
      >
        I am a computer engineer, constantly improving myself and actively
        developing skills in various programming languages and software
        development technologies. With in-depth knowledge in JavaScript,
        React.js, C, and Python, I aim to successfully complete projects by
